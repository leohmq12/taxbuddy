...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.example.taxbuddy"
        ...
        manifestPlaceholders["API KEY"] = apiKey
    }
...
dependencies {
    ...
    implementation ("com.google.android.gms:play-services-measurement-api:22.2.0") // Older version
